...
var TodoList = [{
            description: "Have to Buy some Books",
            date: "MAY 2,2019",
            category: "Work"
        },
        {
    ...
    //this controller is created for renedering the page where data comes from the database and is rendered to the browser
...
module.exports.todoPostlist = (req, res) => {
        ...
        //a collection is created inthe database    
        TodoContact.create({
